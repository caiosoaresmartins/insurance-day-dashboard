  ...
  return (
    <div style={{maxWidth:420,margin:'0 auto',padding:'40px 0'}}>
      ...
      <div style={CARD}>
        ...
        <button onClick={go} style={{marginTop:16,width:'100%',padding:'13px',background:GOLD,border:'none',borderRadius:8,color:'#000',fontWeight:800,fontSize:15,cursor:'pointer',letterSpacing:2}}>ENTRAR &#8594;</button>
      </div>
    </div>
  );
}
